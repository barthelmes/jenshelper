  ...
  theme_grey(base_size = font_size, base_family = font_family) %+replace%
    theme(
      ...
      axis.text = element_text(color = "black",
                               size = font_size),
      axis.text.x = element_text(margin = margin(t = small_size / 2),
                                 vjust = 1),
      axis.text.x.top = element_text(margin = margin(b = small_size / 2),
                                     vjust = 0),
      axis.text.y = element_text(margin = margin(r = small_size / 2),
                                 hjust = 1),
      axis.text.y.right = element_text(margin = margin(l = small_size / 2),
                                       hjust = 0),
